...
async def main():
    ...
    # ── MEGAcmd single session — no account pool needed ──
    my_accounts = ["MEGA_SESSION"]
    primary_acc = "MEGA_SESSION"
    logger.info("☁️ Upload mode: MEGAcmd single session token")
